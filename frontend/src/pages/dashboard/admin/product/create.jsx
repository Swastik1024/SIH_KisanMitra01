          ...
          <div style={{ background: 'white', borderRadius: '20px', padding: '30px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                >
                  📁 {images.length > 0 ? `Change Images (${images.length} selected)` : 'Browse & Upload Images'}
                </label>
                {images.length > 0 && <p style={{ fontSize: '13px', color: '#166534', fontWeight: '600', marginTop: '6px' }}>✓ {images.length} image(s) attached</p>}
              </div>
